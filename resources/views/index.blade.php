...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />-->
    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{asset('asset2/css/bootstrap.css')}}" rel='stylesheet' type='text/css' />

    <!--personal css-->
    <link href="{{asset('asset2/css/mycss.css')}}" rel='stylesheet' type='text/css' />
...
<main>
    ...
    <div class="main-content">
        <div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
            ...
            <aside class="sidebar-left pt-1 overflow-auto">
                ...
                <div class="row-one widgettable">
                    ...
                    <div class="col-md-3 stat">
                        ...
                        <div class="content-top-1">
                            <div class="col-md-6 top-content">
                                <h5>Visitors</h5>
                                <label>None at the moment</label>
                            </div>
                            <div class="col-md-6 top-content1">
                    ...
                    <div class="col-md-2 stat">
                        <div class="content-top">
                            ...
                            <ul class="info">
                                <li class="col-md-6"><b>No friends for now</b><p>Friends</p></li>
                        ...
                        <div class="content-top">
                            ...
                            <ul class="info">
                                <li class="col-md-6"><b>No Follwers yet</b><p>Followers</p></li>
                        ...
                        <div class="content-top">
                            ...
                            <ul class="info">
                                <li class="col-md-6"><b>0 followers</b><p>Followers</p></li>
                    ...
                    <div class="mid-content-top charts-grids">
                        <div class="middle-content">
                            ...
                            <div id="owl-demo" class="owl-carousel text-center">
                                <div class="item">
                                    <img class="lazyOwl img-responsive" data-src="{{asset('asset/images/slider1.jpg')}}" alt="name">
                                </div>
                                <div class="item">
                                    <img class="lazyOwl img-responsive" data-src="{{asset('asset/images/slider2.jpg')}}" alt="name">
                                </div>
                                <div class="item">
                                    <img class="lazyOwl img-responsive" data-src="{{asset('asset/images/slider3.jpg')}}" alt="name">
                                </div>
                                <div class="item">
                                    <img class="lazyOwl img-responsive" data-src="{{asset('asset/images/slider4.jpg')}}" alt="name">
                                </div>
                                <div class="item">
                                    <img class="lazyOwl img-responsive" data-src="{{asset('asset/images/slider5.jpg')}}" alt="name">
                                </div>
                                <div class="item">
                                    <img class="lazyOwl img-responsive" data-src="{{asset('asset/images/slider6.jpg')}}" alt="name">
                                </div>
                                <div class="item">
                                    <img class="lazyOwl img-responsive" data-src="{{asset('asset/images/slider7.jpg')}}" alt="name">
                                </div>
                    ...
                    <div class="col-md-4 span_8">
                        <div class="activity_box">
                            ...
                            <div class="scrollbar" id="style-1">
                                ...
                                <div class="activity-row">
                                    <div class="col-xs-3 activity-img"><img src="{{asset('asset/images/4.jpg')}}" class="img-responsive" alt=""/></div>
                                    <div class="col-xs-7 activity-desc">
                                        <h5><a href="#">Mugiira Kevin</a></h5>
                                        <p>Hey ! There I'm available.</p>
                                    </div>
                                ...
                                <div class="activity-row">
                                    <div class="col-xs-3 activity-img"><img src='{{asset('asset/images/3.jpg')}}' class="img-responsive" alt=""/></div>
                                    <div class="col-xs-7 activity-desc">
                                        <h5><a href="#">Mr Kibui</a></h5>
                                        <p>Hey ! There Im available.</p>
                                    </div>
                                    <div class="col-xs-2 activity-desc1"><h6>01:30 PM</h6></div>
                                    <div class="clearfix"> </div>
                                </div>
                                <div class="activity-row">
                                    <div class="col-xs-3 activity-img"><img src='{{asset('asset/images/2.jpg')}}' class="img-responsive" alt=""/></div>
                                    <div class="col-xs-7 activity-desc">
                                        <h5><a href="#">Mugiira Kevin</a></h5>
                                        <p>Hey ! There I'm available.</p>
                                    </div>
                            ...
                            <div class="scrollbar" id="style-3">
                                <div class="activity-row activity-row1">
                                    ...
                                    <div class="col-xs-5 activity-img1">
                                        <div class="activity-desc-sub">
                                            <h5>Mugiira Kevin</h5>
                                            <p>Hello ! this is Mugiira Kevin</p>
                                        </div>
                                    </div>
                                ...
                                <div class="activity-row activity-row1">
                                    ...
                                    <div class="col-xs-7 activity-img2">
                                        <div class="activity-desc-sub1">
                                            <h5>Mwaniki</h5>
                                            <p>Sasa, Tunafaa kukutana lini?</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3 activity-img"><img src='{{asset('asset/images/3.jpg')}}' class="img-responsive" alt=""/><span>06:02 AM</span></div>
                                    <div class="clearfix"> </div>
                                </div>
                                <div class="activity-row activity-row1">
                                    <div class="col-xs-3 activity-img"><img src='{{asset('asset/images/1.jpg')}}' class="img-responsive" alt=""/><span>06:05 AM</span></div>
                                    <div class="col-xs-5 activity-img1">
                                        <div class="activity-desc-sub">
                                            <h5>Martin Onyango</h5>
                                            <p>Poa sana, leo uko wapi</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-4 activity-desc1"></div>
                                    <div class="clearfix"> </div>
                                ...
                                <div class="activity-row activity-row1">
                                    ...
                                    <div class="col-xs-7 activity-img2">
                                        <div class="activity-desc-sub1">
                                            <h5>Mugiira Kevin</h5>
                                            <p>Hiyo ni poa sana</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3 activity-img"><img src='{{asset('asset/images/3.jpg')}}' class="img-responsive" alt=""/><span>06:20 PM</span></div>
                                    <div class="clearfix"> </div>
                                </div>
                            </div>
                            <form action="#" method="post">
