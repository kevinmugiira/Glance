...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="tables">
                <h2 class="title1">Edit Sub Categories Collection Form</h2>

                <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                    <div class="form-title">
                        <h4>Edit a Sub Category :
                        ...
                        <form action="{{ url('sub-category-update/'.$subcategory->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="4"
                                              name="description"
                                              class="form-control"
                                              placeholder="Enter Description"> {{$subcategory->description}}
                                </textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('uploads/subcategoryimage/'.$subcategory->image) }}" width="100px">
                            ...
                            <div class="checkbox"> <label>
                                    <input type="checkbox" name="status" {{ $subcategory->status == '1' ? 'checked' : ''}}> Show/Hide </label>
                            </div>
