...
<head>
    <title>NewGreen Solutions</title>
    <!--/tags -->
        ...
        <div class="col-md-8 header">
            ...
            <div class="agileits_search">
                <form action="#" method="post">
                    <input name="Search" type="search" placeholder="Search for fresh produce?" required="">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            <li class="active">
                                <a class="nav-stylehead" href="{{url('mtaa')}}">Home
                                    ...
                                    <div class="agile_inner_drop_nav_info">
                                        <div class="col-sm-4 multi-gd-img">
                                            <ul class="single-column-dropdown">
                                                ...
                                                <li>
                                                    <a href="{{url('products')}}">Fiber Crops</a>
                                                </li>
                                                <li>
                                                    <a href="{{url('products')}}">Oil Crops</a>
                                                </li>
                                                <li>
                                                    <a href="{{url('products')}}">Ornamental Crops</a>
                                                </li>
                                                <li>
                                                    <a href="{{url('products')}}">Industrial Crops</a>
                                                </li>
                           ...
                           <!-- <li class="dropdown">
                            ...
                            <li class="">
                                <a class="nav-stylehead" href="{{url('contact')}}">Contact us</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!--<div class="footer-top">
    <div class="container-fluid">
        ...
        <div class="col-xs-4 w3l-rightmk">
            <img src="{{asset('asset2/images/tab3.png')}}" alt=" ">
        </div>
        <div class="clearfix"></div>
    </div>
</div>-->
    ...
    <div class="container">
       ...
       <!-- <div class="agile-sometext">
          ...
          <!--  <div class="sub-some child-momu">
                ...
                <ul>
                    <li>
                        <img src="{{asset('asset2/images/pay2.png')}}" alt="">
                    </li>
                    <li>
                        <img src="{{asset('asset2/images/pay5.png')}}" alt="">
                    </li>
                    <li>
                        <img src="{{asset('asset2/images/pay1.png')}}" alt="">
                    </li>
                    <li>
                        <img src="{{asset('asset2/images/pay4.png')}}" alt="">
                    </li>
                    <li>
                        <img src="{{asset('asset2/images/pay6.png')}}" alt="">
                    </li>
                    <li>
                        <img src="{{asset('asset2/images/pay3.png')}}" alt="">
                    </li>
                    <li>
                        <img src="{{asset('asset2/images/pay7.png')}}" alt="">
                    </li>
                    <li>
                        <img src="{{asset('asset2/images/pay8.png')}}" alt="">
                    </li>
                    <li>
                        <img src="{{asset('asset2/images/pay9.png')}}" alt="">
                    </li>
                </ul>
            </div>-->
            <!-- //payment -->
...
<!-- js-files -->
<!-- jquery -->
<script src="{{asset('asset2/js/jquery-2.1.4.min.js')}}"></script>
<!-- //jquery -->

<!-- popup modal (for signin & signup)-->
<script src="{{asset('asset2/js/jquery.magnific-popup.js')}}"></script>
<script>
...
<!-- cart-js -->
<script src="{{asset('asset2/js/minicart.js')}}"></script>
<script>
...
<script src="{{asset('asset2/js/jquery.flexisel.js')}}"></script>
<script>
    $(window).load(function () {
...
<!-- smoothscroll -->
<script src="{{asset('asset2/js/SmoothScroll.min.js')}}"></script>
<!-- //smoothscroll -->

<!-- start-smooth-scrolling -->
<script src="{{asset('asset2/js/move-top.js')}}"></script>
...
<!-- imagezoom -->
<script src="{{asset('asset2/js/imagezoom.js')}}"></script>
<!-- //imagezoom -->

<!-- FlexSlider -->
<script src="{{asset('asset2/js/jquery.flexslider.js')}}"></script>
<script>
