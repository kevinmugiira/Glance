            ...
            <div class="col-md-4 compose-left">
                ...
                <div class="chat-grid widget-shadow">
                    <ul>
                        ...
                        <li><a href="#">
                                <div class="chat-left">
                                    <img class="img-circle" src="{{asset('asset/images/i1.png')}}" alt="">
                        ...
                        <li><a href="#">
                                <div class="chat-left">
                                    <img class="img-circle" src="{{asset('asset/images/i2.png')}}" alt="">
                        ...
                        <li><a href="#">
                                <div class="chat-left">
                                    <img class="img-circle" src="{{asset('asset/images/i3.png')}}" alt="">
                                    <label class="small-badge bg-green"></label>
                                </div>
                                <div class="chat-right">
                                    <p>Elisa liden </p>
                        ...
                        <li><a href="#">
                                <div class="chat-left">
                                    <img class="img-circle" src="{{asset('asset/images/i4.png')}}" alt="">
                                    <label class="small-badge"></label>
                                </div>
                                <div class="chat-right">
                                    <p>Michael John</p>
                ...
                <div class="panel-default">
                    ...
                    <div class="inbox-page">
                        ...
                        <div class="inbox-row widget-shadow" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="mail"><img src="{{asset('asset/images/i1.png')}}" alt=""/></div>
                        ...
                        <div class="inbox-row widget-shadow" id="accordion1" role="tablist" aria-multiselectable="true">
                            <div class="mail "> <input type="checkbox" class="checkbox"> </div>
                            <div class="mail"><img src="{{asset('asset/images/i2.png')}}" alt=""/></div>
                        ...
                        <div class="inbox-row widget-shadow">
                            <div class="mail "> <input type="checkbox" class="checkbox"> </div>
                            <div class="mail"><img src="{{asset('asset/images/i3.png')}}" alt=""/></div>
                        ...
                        <div class="inbox-row widget-shadow">
                            <div class="mail "> <input type="checkbox" class="checkbox"> </div>
                            <div class="mail"><img src="{{asset('asset/images/i4.png')}}" alt=""/></div>
